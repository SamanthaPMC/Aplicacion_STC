...
import {register } from '../../../actions/auntentificarFirebase';
    ...
    const saveUsuario = async()=>{
        try {
            ...
            register(NombreApellido,Ci,Telefono,Email)
                .then(async ()=>{
                    if (Ci&&NombreApellido&&Telefono&&Email){
                            navigation.navigate('StartScreen',{NombreApellido:NombreApellido, CI:Ci,Telefono:Telefono,Email})
                    }
                })
